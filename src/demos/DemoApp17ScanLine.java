...
public class DemoApp17ScanLine {
    public static void main(String[] args) {
        JFrame frame = new JFrame("Demo 17: Scan Line");
        ...
        FillerScanLine scanner = new FillerScanLine(Color.RED);
